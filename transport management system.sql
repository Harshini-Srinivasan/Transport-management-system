...
DROP TABLE IF EXISTS TripDrivers; -- Drop TripDrivers first as it has foreign key dependencies
DROP TABLE IF EXISTS Trips;  
DROP TABLE IF EXISTS Passengers;  
DROP TABLE IF EXISTS Routes;  
DROP TABLE IF EXISTS Vehicles;  
DROP TABLE IF EXISTS Drivers; -- Drop the Drivers table if it exists
...
-- Now insert data into the Vehicles table
-- 1. Add a New Vehicle
